    ...
    const handleImageOptions = () => {
        Alert.alert(
            ...
            [
                ...
                {
                    text: 'URL',
                    onPress: () => setShowUrlModal(true), // 🔥 Abrir modal
                },
                {
                    text: 'Cancelar',
                    style: 'cancel',
    ...
    return (
        <View className="flex-1 bg-[#131b23] pt-5">
            <View className="flex-row items-center px-4 py-3 border-b border-gray-800">
                ...
                <Text className="text-white text-xl font-bold ml-2">Add Recipe</Text>
            </View>
            ...
            <ScrollView className="flex-1 px-4 pt-4">
                ...
                >
                    <Text className="text-black text-lg font-bold">Add recipe</Text>
                </TouchableOpacity>
            </ScrollView>
